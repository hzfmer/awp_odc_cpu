...
C      integer, dimension (:,:), allocatable :: tpsrc,psrc
      ...
      integer, dimension(:), allocatable :: src_locs
...
c        allocate(weights_s(0:nxt+1,0:nyt+1,0:nzt+1))
c        allocate(weights_p(0:nxt+1,0:nyt+1,0:nzt+1))
